...
const innovations = [
  { icon:Cpu, title:'Smart Automation & IoT', img:'/images/9_prod_pre_engineered_buildings.png',
  ...
  { icon:Leaf, title:'Sustainable Manufacturing', img:'/images/High-End-Automated-Fly-ash-brick.png',
  ...
  { icon:Zap, title:'High-Efficiency Autoclave Technology', img:'/images/1_prod_aac_plant.png',
  ...
  { icon:BarChart3, title:'Calcium Silicate & Fibre Board Plants', img:'/images/calcium-silicate_fiber-boards.png',
    ...
    <div>
      <section className="relative py-24 bg-navy-900">
        <div className="absolute inset-0 bg-cover bg-center opacity-15"
          style={{ backgroundImage:"url('/images/9_prod_pre_engineered_buildings.png')" }}/>
