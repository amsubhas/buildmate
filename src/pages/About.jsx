      ...
      <section id="advantages" className="py-20 bg-navy-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-7" variants={SC} initial="hidden" whileInView="visible" viewport={VP}>
            {[
              { title:'Superior Design', img:'https://www.buildmate.in/images/sup_design.jpg', desc:'Every plant is engineered from first principles. Optimised layouts, energy-efficient process flows and future-ready automation architecture. 3D modelling and simulation before fabrication.' },
              { title:'Meticulous Manufacturing', img:'https://www.buildmate.in/images/meti_mfg.jpg', desc:'In-house CNC machining, precision fabrication and rigorously tested sub-assemblies ensure zero-compromise quality at every stage — from raw material to finished equipment.' },
              { title:'Immaculate Quality', img:'https://www.buildmate.in/images/imm_quality.jpg', desc:'ISO 9001:2015 certified quality management. 100% pre-dispatch inspection, factory acceptance tests and on-site commissioning validation. Quality documented at every step.' },
            ].map(a => (
