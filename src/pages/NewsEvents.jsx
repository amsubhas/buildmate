...
const events = [
  {
    ...
    img:'https://buildmate.in/images/Excon_13th_edition.jpg',
  ...
  },
  {
    ...
    img:'https://buildmate.in/images/fly_ash_utilisation_conference_2024.jpg',
  ...
  },
  {
    ...
    img:'https://buildmate.in/images/World_of_concrete_2024.jpg',
    ...
    <div>
      <section className="relative py-24 bg-navy-900">
        <div className="absolute inset-0 bg-cover bg-center opacity-20"
          style={{ backgroundImage:"url('https://buildmate.in/images/Excon_13th_edition.jpg')" }}/>
