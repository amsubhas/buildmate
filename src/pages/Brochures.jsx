...
import { cmsAsset, cmsConfigured, cmsList } from '../cms/directus'
...
const BROCHURE_IMAGES = {
  'aac-plants':'/images/1_prod_aac_plant.png',
  'dry-mix-mortar-plants':'/images/4_prod_dry_mix_mortar_plants.png',
  'precast-concrete-plants':'/images/5_prod_precast_concrete_plants.png',
  'concrete-block-brick-plants':'/images/6_prod_concrete-block-plants.png',
  'stone-crushing-plants':'/images/2_prod_crushers_plant.png',
  'concrete-blocks':'/images/6_concrete_block_plants.jpeg',
  'precast-concrete-elements':'/images/5_precast_concrete_plants.jpeg',
  'concrete-batching-plants':'/images/3_prod_concrete-batching-plants.png',
  'cranes-and-pebs':'/images/7_prod_cranes.png',
  'mixers':'/images/8_prod_mixers.png',
  'special-projects':'/images/10_prod_special_projects.png',
}

const FALLBACK_BROCHURES = [
  { id:'aac-plants', title:'AAC Plants', subtitle:'Autoclaved Aerated Concrete Manufacturing', category:'Manufacturing Plants', img:BROCHURE_IMAGES['aac-plants'], pdf:'/brochures/pdf/Buildmate_01-AAC-Plants.pdf', pages:12, desc:'Buildmate branded technical brochure covering AAC plant engineering, production systems, equipment and project delivery.', highlights:['AAC plant solutions','Plant engineering','Production systems','Project delivery'], tag:'Flagship Product' },
  { id:'dry-mix-mortar-plants', title:'Dry Mix Mortar Plants', subtitle:'Automated Dry Mortar Production', category:'Manufacturing Plants', img:BROCHURE_IMAGES['dry-mix-mortar-plants'], pdf:'/brochures/pdf/Buildmate_02-Dry-Mix-Mortar-Plants.pdf', pages:11, desc:'Buildmate branded technical brochure covering dry mix mortar plant concepts, controlled dosing, handling and production configurations.', highlights:['5-50 TPH range','Tower or horizontal','Production systems','Automation'], tag:'Dry Mix' },
  { id:'precast-concrete-plants', title:'Precast Concrete Plants', subtitle:'Facades, Walls & Structural Elements', category:'Manufacturing Plants', img:BROCHURE_IMAGES['precast-concrete-plants'], pdf:'/brochures/pdf/Buildmate_03-Precast-Concrete-Plants.pdf', pages:12, desc:'Buildmate branded technical brochure covering precast plant solutions, moulding, casting and handling systems.', highlights:['Precast systems','Casting solutions','Mould systems','Turnkey delivery'], tag:'Precast' },
  { id:'concrete-block-brick-plants', title:'Concrete Block / Brick Plants', subtitle:'Automated Concrete Product Manufacturing', category:'Manufacturing Plants', img:BROCHURE_IMAGES['concrete-block-brick-plants'], pdf:'/brochures/pdf/Buildmate_04-Concrete-Block-Brick-Plants.pdf', pages:12, desc:'Buildmate branded brochure for concrete block and brick plant solutions, production systems and applications.', highlights:['Block production','Brick systems','Automation','Product flexibility'], tag:'Block Plants' },
  { id:'stone-crushing-plants', title:'Stone Crushing Plants', subtitle:'Aggregate Processing Systems', category:'Processing Equipment', img:BROCHURE_IMAGES['stone-crushing-plants'], pdf:'/brochures/pdf/Buildmate_05-Stone-Crushing-Plants.pdf', pages:12, desc:'Buildmate branded technical brochure covering stone crushing and aggregate processing plant solutions.', highlights:['Crushing systems','Screening','Material processing','Plant engineering'], tag:'Crushing' },
  { id:'concrete-blocks', title:'Concrete Blocks', subtitle:'Concrete Product Range', category:'Product Catalogue', img:BROCHURE_IMAGES['concrete-blocks'], pdf:'/brochures/pdf/Buildmate_06-Concrete-Blocks.pdf', pages:9, desc:'Buildmate branded product brochure covering concrete block products, characteristics and applications.', highlights:['Product range','Applications','Block products','Technical details'], tag:'Catalogue' },
  { id:'precast-concrete-elements', title:'Precast Concrete Elements', subtitle:'Structural & Architectural Elements', category:'Product Catalogue', img:BROCHURE_IMAGES['precast-concrete-elements'], pdf:'/brochures/pdf/Buildmate_07-Precast-Concrete-Elements.pdf', pages:12, desc:'Buildmate branded product brochure covering precast concrete elements for architectural and structural applications.', highlights:['Walls & facades','Beams & elements','Staircases','Custom products'], tag:'Catalogue' },
  { id:'concrete-batching-plants', title:'Concrete Batching Plants', subtitle:'Concrete Production Systems', category:'Manufacturing Plants', img:BROCHURE_IMAGES['concrete-batching-plants'], pdf:'/brochures/pdf/Buildmate_08-Concrete-Batching-Plants.pdf', pages:13, desc:'Buildmate branded technical brochure covering batching plant configurations, mixing and material handling systems.', highlights:['Batching systems','Mixing solutions','Material handling','Plant layouts'], tag:'Batching' },
  { id:'cranes-and-pebs', title:'Cranes & PEBs', subtitle:'Material Handling & Steel Structures', category:'Equipment & Structures', img:BROCHURE_IMAGES['cranes-and-pebs'], pdf:'/brochures/pdf/Buildmate_09-Cranes-and-PEBs.pdf', pages:11, desc:'Buildmate branded brochure covering crane systems and Pre-Engineered Building solutions for industrial facilities.', highlights:['Cranes','PEB systems','Industrial structures','Engineering solutions'], tag:'Equipment' },
  { id:'mixers', title:'Mixers', subtitle:'Industrial Mixing Solutions', category:'Equipment', img:BROCHURE_IMAGES['mixers'], pdf:'/brochures/pdf/Buildmate_10-Mixers.pdf', pages:11, desc:'Buildmate branded technical brochure covering industrial mixer solutions and applications.', highlights:['Industrial mixers','Concrete mixing','Mortar mixing','Process applications'], tag:'Mixing' },
  { id:'special-projects', title:'Special Projects', subtitle:'Custom Industrial Engineering Solutions', category:'Special Projects', img:BROCHURE_IMAGES['special-projects'], pdf:'/brochures/pdf/Buildmate_11-Special-Projects.pdf', pages:10, desc:'Buildmate branded brochure covering special project engineering and tailored industrial plant solutions.', highlights:['Custom projects','Engineering support','Tailored solutions','Project execution'], tag:'Special Projects' },
]

function mapCmsBrochure(b) {
  return {
    id:b.slug,
    title:b.title,
    subtitle:b.title,
    category:b.category || 'Product Brochure',
    img:BROCHURE_IMAGES[b.slug] || '',
    pdf:cmsAsset(b.pdf),
    pages:b.pages || 0,
    desc:b.description || '',
    highlights:[],
  ...
  return (
    <motion.article variants={FV} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}
      ...
      <div className="relative h-44 overflow-hidden bg-navy-800">
        {b.img && <img src={b.img} alt={b.title} loading="lazy" className="w-full h-full object-cover transition-transform duration-700" style={{transform:hover?'scale(1.06)':'scale(1)',opacity:.65}}/>}
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        {b.highlights.length > 0 && <div className="grid grid-cols-2 gap-1.5 mb-5">{b.highlights.map(h => <div key={h} className="flex items-center gap-1.5 text-[11px] text-slate-300"><span className="w-1.5 h-1.5 rounded-full bg-[#C8281E] shrink-0"/>{h}</div>)}</div>}
...
export default function Brochures() {
  ...
  const [brochures, setBrochures] = useState(FALLBACK_BROCHURES)

  useEffect(() => {
    if (!cmsConfigured) return
    let cancelled = false
    cmsList('brochures', { sort:'sort', limit:-1, fields:'*' })
      .then(({ data }) => {
        if (!cancelled && Array.isArray(data) && data.length > 0) setBrochures(data.map(mapCmsBrochure))
      })
      .catch(() => {})
      ...
      <section className="relative py-24 bg-navy-900 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-6 mt-8">
            {[[String(brochures.length),'Product Brochures'],['CMS','Source of Truth'],['Free','Download'],['PDF','Format']].map(([n,l]) => <div key={l} className="flex items-center gap-2"><span className="font-display font-bold text-2xl text-[#192D78]">{n}</span><span className="text-slate-400 text-xs uppercase tracking-wide font-display">{l}</span></div>)}
          </div>
        </div>
      </section>
